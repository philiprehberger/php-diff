...
### Added
- `ignoreWhitespace()`, `ignoreCase()`, and `ignoreBlankLines()` modifiers for string diffs
- Context lines parameter for `toUnified()` output
- `toAnsi()` method for terminal-colored diff output

## [1.1.0] - 2026-03-22

### Added
- `similarity()` method returning 0.0–1.0 indicating how similar two texts are
- `toHtmlSideBySide()` method for side-by-side HTML diff rendering

## [1.0.4] - 2026-03-20

### Added
- Expanded test suite with dedicated formatter tests and edge case coverage
